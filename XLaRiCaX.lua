...
local XLaRiCaX = io.open("XLaRiCaX", 'w')
XLaRiCaX:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
lua5.3 XLaRiCaX.lua
...
os.execute('chmod +x XLaRiCaX;chmod +x Run;./Run')
end
...
XLaRiCaX = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..XLaRiCaX)
LuaTele = luatele.set_config{api_id=14471516,api_hash='94a6d01e235a29c5f8032f942011095d',session_name=XLaRiCaX,token=Token}
LUATELE = URL.escape(""..XLaRiCaX.."\n"..UserBot.."\n"..UserSudo.."\n"..Token.."")
function var(value)  
...
Status = 0
Devss = Redis:sismember(XLaRiCaX.."Devss:Groups",UserId) 
Dev = Redis:sismember(XLaRiCaX.."Dev:Groups",UserId)
Supcreator = Redis:sismember(XLaRiCaX.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(XLaRiCaX.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(XLaRiCaX.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(XLaRiCaX.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(XLaRiCaX.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(XLaRiCaX.."Special:Group"..ChatId,UserId)
...
elseif UserId == XLaRiCaX then
Status = 'البوت'
elseif Devss then
Status = Redis:get(XLaRiCaX.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
Status = Redis:get(XLaRiCaX.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif Owners then
Status = Redis:get(XLaRiCaX.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif Supcreator then
Status = Redis:get(XLaRiCaX.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Creator then
Status = Redis:get(XLaRiCaX.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Manger then
Status = Redis:get(XLaRiCaX.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Admin then
Status = Redis:get(XLaRiCaX.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الكروب'
elseif Special then
Status = Redis:get(XLaRiCaX.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(XLaRiCaX.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(XLaRiCaX.."lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(XLaRiCaX.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(XLaRiCaX.."Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(XLaRiCaX.."Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(XLaRiCaX.."Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(XLaRiCaX.."Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(XLaRiCaX.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(XLaRiCaX.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(XLaRiCaX.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(XLaRiCaX.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(XLaRiCaX.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(XLaRiCaX.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(XLaRiCaX.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(XLaRiCaX.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(XLaRiCaX.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(XLaRiCaX.."Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(XLaRiCaX.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(XLaRiCaX.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(XLaRiCaX.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(XLaRiCaX.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(XLaRiCaX.."Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(XLaRiCaX.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(XLaRiCaX.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(XLaRiCaX.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(XLaRiCaX.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(XLaRiCaX.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(XLaRiCaX.."Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(XLaRiCaX.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(XLaRiCaX.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(XLaRiCaX.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(XLaRiCaX.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(XLaRiCaX.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(XLaRiCaX.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{
BanAll = Redis:sismember(XLaRiCaX.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(XLaRiCaX.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(XLaRiCaX.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(XLaRiCaX.."SilentGroup:Group"..ChatId,UserId)
}
end
...
elseif UserId == XLaRiCaX then Status = true
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,XLaRiCaX).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(XLaRiCaX.."chfalse")
if chh then
...
if Redis:sismember(XLaRiCaX.."BanGroup:Group"..chat,useri) then
BanGroupz = "✓"
else
BanGroupz = "✗"
end
if Redis:sismember(XLaRiCaX.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✓"
else
SilentGroupz = "✗"
end
if Redis:sismember(XLaRiCaX.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
if Redis:sismember(XLaRiCaX.."Creator:Group"..chat,useri) then
Originatorsz = "✓"
else
Originatorsz = "✗"
end
if Redis:sismember(XLaRiCaX.."Manger:Group"..chat,useri) then
Managersz = "✓"
else
Managersz = "✗"
end
if Redis:sismember(XLaRiCaX.."Admin:Group"..chat,useri) then
Addictivez = "✓"
else
Addictivez = "✗"
end
if Redis:sismember(XLaRiCaX.."Special:Group"..chat,useri) then
Distinguishedz = "✓"
else
Distinguishedz = "✗"
end
...
local msg_id = msg.id
--var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(XLaRiCaX.."Lock:channell"..msg_chat_id) then
print(Redis:get(XLaRiCaX.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
local m = Redis:get(XLaRiCaX.."chadmin"..msg_chat_id) 
...
Redis:incr(XLaRiCaX..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(XLaRiCaX) then
...
elseif Redis:sismember(XLaRiCaX.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(XLaRiCaX.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(XLaRiCaX.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(XLaRiCaX.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(XLaRiCaX.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(XLaRiCaX.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(XLaRiCaX.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(XLaRiCaX.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(XLaRiCaX.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(XLaRiCaX.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(XLaRiCaX.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(XLaRiCaX.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(XLaRiCaX.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(XLaRiCaX.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(XLaRiCaX) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(XLaRiCaX.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(XLaRiCaX.."Lock:text"..msg_chat_id) and not msg.Special then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(XLaRiCaX.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(XLaRiCaX.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(XLaRiCaX.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(XLaRiCaX) then
return false
end
local floods = Redis:hget(XLaRiCaX.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(XLaRiCaX.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(XLaRiCaX.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(XLaRiCaX.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(XLaRiCaX.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(XLaRiCaX.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⋆ قام بالتكرار في الكروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(XLaRiCaX.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(XLaRiCaX.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(XLaRiCaX.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(XLaRiCaX..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(XLaRiCaX..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(XLaRiCaX.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(XLaRiCaX.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(XLaRiCaX.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(XLaRiCaX.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(XLaRiCaX.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Admin then -- التوجيه
local Fwd_Group = Redis:get(XLaRiCaX.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(XLaRiCaX.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(XLaRiCaX.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(XLaRiCaX.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(XLaRiCaX.."lockpin"..msg_chat_id)
...
Redis:incr(XLaRiCaX.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(XLaRiCaX.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(XLaRiCaX.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(XLaRiCaX) then
local N = (Redis:get(XLaRiCaX.."Name:Bot") or "لاريكا")
photo = LuaTele.getUserProfilePhotos(XLaRiCaX)
...
Redis:set(XLaRiCaX.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(XLaRiCaX.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(XLaRiCaX.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(XLaRiCaX.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(XLaRiCaX.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(XLaRiCaX.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(XLaRiCaX.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(XLaRiCaX.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(XLaRiCaX.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(XLaRiCaX.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(XLaRiCaX.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(XLaRiCaX.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(XLaRiCaX.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(XLaRiCaX.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(XLaRiCaX.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(XLaRiCaX.."Lock:User:Name"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
...
if text and text:match("#[%a%d_]+") and not msg.Special then 
local Hashtak_Group = Redis:get(XLaRiCaX.."Lock:hashtak"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
...
if text and text:match("/[%a%d_]+") and not msg.Special then 
local comd_Group = Redis:get(XLaRiCaX.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(XLaRiCaX.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(XLaRiCaX.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(XLaRiCaX.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(XLaRiCaX.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(XLaRiCaX.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(XLaRiCaX.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(XLaRiCaX.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(XLaRiCaX.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end end
if text and (Redis:get(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(XLaRiCaX.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(XLaRiCaX.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(XLaRiCaX.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(XLaRiCaX.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(XLaRiCaX.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(XLaRiCaX.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(XLaRiCaX.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(XLaRiCaX.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(XLaRiCaX.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(XLaRiCaX.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(XLaRiCaX.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(XLaRiCaX.."Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(XLaRiCaX.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(XLaRiCaX.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(XLaRiCaX.."All:Get:Reides:Commands:Group"..text)
Redis:del(XLaRiCaX.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(XLaRiCaX.."All:Command:List:Group",text)
...
Redis:del(XLaRiCaX.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(XLaRiCaX.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(XLaRiCaX.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(XLaRiCaX.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(XLaRiCaX.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(XLaRiCaX.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(XLaRiCaX.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(XLaRiCaX.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(XLaRiCaX.."All:Command:List:Group",text)
Redis:del(XLaRiCaX.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(XLaRiCaX.."lockalllll"..msg_chat_id) == "off" then
...
if text and Redis:get(XLaRiCaX.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(XLaRiCaX.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(XLaRiCaX.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(XLaRiCaX.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(XLaRiCaX.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(XLaRiCaX.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(XLaRiCaX.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(XLaRiCaX.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(XLaRiCaX.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(XLaRiCaX.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(XLaRiCaX.."Command:List:Group"..msg_chat_id,text)
Redis:del(XLaRiCaX.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(XLaRiCaX.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(XLaRiCaX.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"•  تم الغاء حفظ الرابط","md",true) 
end
Redis:set(XLaRiCaX.."Group:Link"..msg_chat_id,text)
Redis:del(XLaRiCaX.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"•  تم حفظ الرابط بنجاح","md",true) 
end 
if Redis:get(XLaRiCaX.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(XLaRiCaX.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"• تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(XLaRiCaX.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(XLaRiCaX.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ ترحيب الكروب","md",true) 
end
if Redis:get(XLaRiCaX.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(XLaRiCaX.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(XLaRiCaX.."Group:Rules" .. msg_chat_id,text) 
Redis:del(XLaRiCaX.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ قوانين الكروب","md",true)  
end  
if Redis:get(XLaRiCaX.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(XLaRiCaX.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(XLaRiCaX.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(XLaRiCaX.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(XLaRiCaX.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(XLaRiCaX.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(XLaRiCaX.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(XLaRiCaX.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(XLaRiCaX.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(XLaRiCaX.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(XLaRiCaX.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(XLaRiCaX.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(XLaRiCaX.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(XLaRiCaX.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(XLaRiCaX.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
...
Redis:set(XLaRiCaX.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(XLaRiCaX.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(XLaRiCaX.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(XLaRiCaX.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(XLaRiCaX.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(XLaRiCaX.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(XLaRiCaX.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(XLaRiCaX.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(XLaRiCaX.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(XLaRiCaX.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(XLaRiCaX.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(XLaRiCaX.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(XLaRiCaX.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود ","md",true)  
return false
end end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= XLaRiCaX then
local test = Redis:get(XLaRiCaX.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(XLaRiCaX.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(XLaRiCaX.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(XLaRiCaX.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(XLaRiCaX.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(XLaRiCaX.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(XLaRiCaX.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(XLaRiCaX.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الرد \n• ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  end
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(XLaRiCaX.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(XLaRiCaX.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(XLaRiCaX.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(XLaRiCaX..''..v..text)
end
Redis:del(XLaRiCaX.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(XLaRiCaX.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود العامه","md",true)  
end end
if text and not Redis:get(XLaRiCaX.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(XLaRiCaX..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(XLaRiCaX.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(XLaRiCaX.."Add:Rd:Sudo:stekr"..text) 
local Text = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(XLaRiCaX.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(XLaRiCaX.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(XLaRiCaX.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(XLaRiCaX..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(XLaRiCaX..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(XLaRiCaX.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text and not Redis:get(XLaRiCaX.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(XLaRiCaX.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(XLaRiCaX.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(XLaRiCaX.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
local Texingt = Redis:get(XLaRiCaX.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(XLaRiCaX.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(XLaRiCaX.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(XLaRiCaX.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(XLaRiCaX.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(XLaRiCaX.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(XLaRiCaX.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(XLaRiCaX.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(XLaRiCaX.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(XLaRiCaX..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if Redis:get(XLaRiCaX.."XLaRiCaX:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(XLaRiCaX.."XLaRiCaX:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(XLaRiCaX.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(XLaRiCaX.."XLaRiCaX:PinMsegees:"..v,text)
end
end
...
if Redis:get(XLaRiCaX.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(XLaRiCaX.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(XLaRiCaX.."Num:User:Pv") 
...
if Redis:get(XLaRiCaX.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(XLaRiCaX.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(XLaRiCaX.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(XLaRiCaX.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(XLaRiCaX.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(XLaRiCaX.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(XLaRiCaX.."ch:admin")
...
if Redis:get(XLaRiCaX.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(XLaRiCaX.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(XLaRiCaX..'GetTexting:DevXLaRiCaX'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء ⋆' then 
Redis:del(XLaRiCaX..'GetTexting:DevXLaRiCaX'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم الغاء حفظ كليشة المطور')
end
Redis:set(XLaRiCaX..'Texting:DevXLaRiCaX',text)
Redis:del(XLaRiCaX..'GetTexting:DevXLaRiCaX'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم حفظ كليشة المطور')
end
if Redis:get(XLaRiCaX.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(XLaRiCaX.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(XLaRiCaX.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(XLaRiCaX.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم تعين الايدي عام',"md",true)  
end
if Redis:get(XLaRiCaX.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تعين الايدي","md",true)  
Redis:del(XLaRiCaX.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(XLaRiCaX.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(XLaRiCaX.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(XLaRiCaX.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(XLaRiCaX.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تغيير اسم البوت","md",true)  
end 
Redis:del(XLaRiCaX.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(XLaRiCaX.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⋆ تم تغيير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(XLaRiCaX.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(XLaRiCaX.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(XLaRiCaX.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(XLaRiCaX.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⋆ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(XLaRiCaX.."Game:Smile"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Smile"..msg.chat_id) then
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(XLaRiCaX.."Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(XLaRiCaX.."mshaher"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."mshaher"..msg.chat_id) then
Redis:del(XLaRiCaX.."mshaher"..msg.chat_id)
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - شخصيات او مشاهير","md",true)  
end
end 
if Redis:get(XLaRiCaX.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Monotonous"..msg.chat_id) then
Redis:del(XLaRiCaX.."Game:Monotonous"..msg.chat_id)
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(XLaRiCaX.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Riddles"..msg.chat_id) then
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(XLaRiCaX.."Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(XLaRiCaX.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(XLaRiCaX.."Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(XLaRiCaX.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:enkliz"..msg.chat_id) then
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(XLaRiCaX.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(XLaRiCaX.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(XLaRiCaX.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(XLaRiCaX.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Reflection"..msg.chat_id) then
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(XLaRiCaX.."Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(XLaRiCaX.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(XLaRiCaX.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(XLaRiCaX.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(XLaRiCaX.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(XLaRiCaX.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(XLaRiCaX.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(XLaRiCaX.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(XLaRiCaX.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(XLaRiCaX.."Game:Difference"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Difference"..msg.chat_id) then 
Redis:del(XLaRiCaX.."Game:Difference"..msg.chat_id)
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - المختلف","md",true)  
end
end
if Redis:get(XLaRiCaX.."Game:Example"..msg.chat_id) then
if text == Redis:get(XLaRiCaX.."Game:Example"..msg.chat_id) then 
Redis:del(XLaRiCaX.."Game:Example"..msg.chat_id)
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - امثله","md",true)  
end
end
if text then
local NewCmmd = Redis:get(XLaRiCaX.."All:Get:Reides:Commands:Group"..text) or Redis:get(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(XLaRiCaX.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(XLaRiCaX.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(XLaRiCaX.."chfalse")
Redis:set(XLaRiCaX.."chfalse",ch)
Redis:del(XLaRiCaX.."ch:admin")
Redis:set(XLaRiCaX.."ch:admin",data.result.invite_link)
else
...
if tonumber(XLaRiCaX) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(XLaRiCaX..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(XLaRiCaX.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(XLaRiCaX.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(XLaRiCaX.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(XLaRiCaX.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(XLaRiCaX.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(XLaRiCaX.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(XLaRiCaX) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(XLaRiCaX.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(XLaRiCaX.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(XLaRiCaX.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(XLaRiCaX.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(XLaRiCaX.."Supcreator:Group"..idg,idASAS)
end;end
end
...
Redis:set(XLaRiCaX.."SendBcBot",true) 
...
Redis:set(XLaRiCaX.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(XLaRiCaX.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(XLaRiCaX.."AddSudosNew"..msg_chat_id)
...
Redis:set(XLaRiCaX.."AddSudosNew"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(XLaRiCaX.."SendBcBot") then
...
Redis:setex(XLaRiCaX.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(XLaRiCaX.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(XLaRiCaX.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(XLaRiCaX.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(XLaRiCaX.."XLaRiCaX:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if not Redis:get(XLaRiCaX.."chmembers") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ الامر معطل بالفعل* ',"md",true)  
end
Redis:del(XLaRiCaX.."chmembers")
...
local Info_Members = Redis:smembers(XLaRiCaX.."BanAll:Groups") 
...
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(XLaRiCaX.."XLaRiCaX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(XLaRiCaX.."XLaRiCaX11:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id, '\n⋆ ارسل الكلمه الان')
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."XLaRiCaX11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(XLaRiCaX..'XLaRiCaX11:Add:Rd:Sudo:Text'..text)
Redis:del(XLaRiCaX..'XLaRiCaX11:Add:Rd:Sudo:Text1'..text)
Redis:del(XLaRiCaX..'XLaRiCaX11:Add:Rd:Sudo:Text2'..text)
Redis:del(XLaRiCaX.."XLaRiCaX11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(XLaRiCaX.."XLaRiCaX11:List:Rd:Sudo", text)
...
local list = Redis:smembers(XLaRiCaX.."XLaRiCaX11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text"..v) 
Redis:del(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text1"..v) 
Redis:del(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text2"..v)   
Redis:del(XLaRiCaX.."XLaRiCaX11:List:Rd:Sudo")
end
...
Redis:set(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(XLaRiCaX.."XLaRiCaX11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"⋆ ارسل الكلمه التي تريد حذفها")
end
if text then  
local test = Redis:get(XLaRiCaX.."XLaRiCaX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = Redis:get(XLaRiCaX.."XLaRiCaX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = Redis:get(XLaRiCaX.."XLaRiCaX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(XLaRiCaX.."XLaRiCaX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = Redis:get(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(XLaRiCaX.."XLaRiCaX11:Add:Rd:Sudo:Text2"..text)   
...
Redis:del(XLaRiCaX.."BanAll:Groups") 
...
local list = Redis:smembers(XLaRiCaX.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Gif"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:vico"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:stekr"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Text"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Photo"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Photoc"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Video"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Videoc"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:File"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Audio"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:Audioc"..v)
Redis:del(XLaRiCaX.."Add:Rd:Sudo:video_note"..v)
Redis:del(XLaRiCaX.."List:Rd:Sudo")
end
...
Redis:set(XLaRiCaX.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:set(XLaRiCaX.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},
...
if text and not Redis:sismember(XLaRiCaX.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(XLaRiCaX.."Spam:Group"..msg.sender.user_id) 
end
if text == 'تفعيل الاشتراك الاجباري لكل الاعضاء ⋆' or text == 'تفعيل الاشتراك الاجباري لكل الاعضاء' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ هذا الامر يخص  '..Controller_Num(1)..'* ',"md",true)  
end
if not Redis:get(XLaRiCaX.."chfalse") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(XLaRiCaX.."chmembers","on")
...
Redis:set(XLaRiCaX.."ch:addd"..msg.sender.user_id,"on")
...
local Groups = Redis:smembers(XLaRiCaX..'ChekBotAdd')  
local UsersBot = Redis:smembers(XLaRiCaX..'Num:User:Pv')  
local Get_Json = '{"BotId": '..XLaRiCaX..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(XLaRiCaX.."Supcreator:Group"..v)
local Constructor = Redis:smembers(XLaRiCaX.."Creator:Group"..v)
local Manager = Redis:smembers(XLaRiCaX.."Manger:Group"..v)
local Admin = Redis:smembers(XLaRiCaX.."Admin:Group"..v)
local Vips = Redis:smembers(XLaRiCaX.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(XLaRiCaX..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⋆ عدد احصائيات البوت الكامله \n•━─━─━─━─━─━─━─━•\n⋆ عدد المجموعات : '..(Redis:scard(XLaRiCaX..'ChekBotAdd') or 0)..'\n⋆ عدد المشتركين : '..(Redis:scard(XLaRiCaX..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(XLaRiCaX..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد الاعضاء قليل لا يمكن تفعيل الكروب  يجب ان يكوم اكثر من :'..Redis:get(XLaRiCaX..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
if Redis:sismember(XLaRiCaX.."ChekBotAdd",msg_chat_id) then
...
Redis:sadd(XLaRiCaX.."ChekBotAdd",msg_chat_id)
Redis:set(XLaRiCaX.."Status:Id"..msg_chat_id,true) ;Redis:del(XLaRiCaX.."Status:Reply"..msg_chat_id) ;Redis:del(XLaRiCaX.."Status:ReplySudo"..msg_chat_id) ;Redis:set(XLaRiCaX.."Status:BanId"..msg_chat_id,true) ;Redis:set(XLaRiCaX.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(XLaRiCaX.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(XLaRiCaX.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(XLaRiCaX.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(XLaRiCaX.."ChekBotAdd",msg_chat_id) then
if text == 'ايدي' then
...
local TotalMsg = Redis:get(XLaRiCaX..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(XLaRiCaX..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(XLaRiCaX.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(XLaRiCaX.."Num:Add:Games"..msg.chat_id..UserId) or 0
if id3am then
...
if msg.reply_to_message_id == 0 then
if not Redis:get(XLaRiCaX.."Status:Id"..msg_chat_id) then
return false
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(XLaRiCaX.."ch:admin")
...
local TotalMsg = Redis:get(XLaRiCaX..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(XLaRiCaX..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(XLaRiCaX.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(XLaRiCaX.."Set:Id:Group"..msg_chat_id) or Redis:get(XLaRiCaX.."Set:Id:Groups")
if Redis:get(XLaRiCaX.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(XLaRiCaX..'Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(XLaRiCaX..'Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
...
local TotalMsg = Redis:get(XLaRiCaX..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(XLaRiCaX..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
'\n⋄︙User Name ↬ @'..UserName..
...
local vip = Redis:smembers(XLaRiCaX.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(XLaRiCaX.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(XLaRiCaX.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(XLaRiCaX.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(XLaRiCaX.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(XLaRiCaX.."Owners:Group"..msg_chat_id) 
local dev = Redis:smembers(XLaRiCaX.."Dev:Groups") 
local devss = Redis:smembers(XLaRiCaX.."Devss:Groups") 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',data = {
...
TheBasics = Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(XLaRiCaX.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(XLaRiCaX.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(XLaRiCaX.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(XLaRiCaX.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(XLaRiCaX.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(XLaRiCaX.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(XLaRiCaX.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(XLaRiCaX.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,XLaRiCaX).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ البوت عضو في الكروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,XLaRiCaX).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✓ ❭' else change_info = '❬ ✗ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(XLaRiCaX.."Devss:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Devss:Groups",UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Dev:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Dev:Groups",UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
----تنزيل تسليه -----
if TextMsg == "خول" then
if not Redis:sismember(XLaRiCaX.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ اتعالج خلاص ?? ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(XLaRiCaX.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(XLaRiCaX.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(XLaRiCaX.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ احسن برضوا دا عيل نجس 😂 ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(XLaRiCaX.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(XLaRiCaX.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(XLaRiCaX.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Jabwa.first_name then
XLaRiCaXusername = '*طلب ↫ *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من ↫ *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
XLaRiCaXusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,XLaRiCaXusername,"md",false, false, false, false, reply_markup)
end
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(XLaRiCaX) then
    return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يحيحان ","md",true)  
  end
  if Redis:sismember(XLaRiCaX..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
    ...
    if Redis:sismember(XLaRiCaX..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(XLaRiCaX..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(XLaRiCaX..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(XLaRiCaX..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تنزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(XLaRiCaX..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(XLaRiCaX..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(XLaRiCaX..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(XLaRiCaX..msg_chat_id.."mutlqat:")
...
Redis:set(XLaRiCaX.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(XLaRiCaX.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(XLaRiCaX.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(XLaRiCaX.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(XLaRiCaX.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(XLaRiCaX.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(XLaRiCaX.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(XLaRiCaX.."Devss:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Dev:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⋆ قائمه مطورين البوت \n •━─━─━─━─━─━─━─━•*\n'
...
local Info_Members = Redis:smembers(XLaRiCaX.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(XLaRiCaX.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(XLaRiCaX.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(XLaRiCaX.."Status:Id"..msg_chat_id,true) 
...
Redis:set(XLaRiCaX.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:del(XLaRiCaX.."Status:Reply"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."Status:ReplySudo"..msg_chat_id) 
...
Redis:set(XLaRiCaX.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(XLaRiCaX.."BotFree",true) 
...
Redis:set(XLaRiCaX.."TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(XLaRiCaX.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(XLaRiCaX.."Status:Welcome"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."Status:Id"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."Status:IdPhoto"..msg_chat_id) 
...
Redis:set(XLaRiCaX.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(XLaRiCaX.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(XLaRiCaX.."Status:BanId"..msg_chat_id) 
...
if not Redis:sismember(XLaRiCaX.."BanAll:Groups",UserId_Info.id) then
...
Redis:srem(XLaRiCaX.."BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(XLaRiCaX.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Creator and not Redis:get(XLaRiCaX.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(XLaRiCaX.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(XLaRiCaX.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(XLaRiCaX.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(XLaRiCaX.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(XLaRiCaX.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(XLaRiCaX.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(XLaRiCaX.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(XLaRiCaX.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(XLaRiCaX.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(XLaRiCaX.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(XLaRiCaX.."LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(XLaRiCaX.."ch:admin")
...
Redis:del(XLaRiCaX.."myphoto"..msg_chat_id)
...
Redis:set(XLaRiCaX.."myphoto"..msg_chat_id,"off")
...
Redis:del(XLaRiCaX.."mybuti"..msg_chat_id)
...
Redis:set(XLaRiCaX.."mybuti"..msg_chat_id,"off")
...
Redis:del(XLaRiCaX.."sayy"..msg_chat_id)
...
Redis:set(XLaRiCaX.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ تم امر امر قول* ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(XLaRiCaX.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(XLaRiCaX.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(XLaRiCaX.."myphoto"..msg_chat_id) == "off" then
...
local Added_Me = Redis:get(XLaRiCaX.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if Redis:get(XLaRiCaX.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("http://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(XLaRiCaX.."chadmin"..msg_chat_id,ch) 
...
Redis:del(XLaRiCaX.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(XLaRiCaX.."chadmin"..msg_chat_id) then
LuaTele.sendText(msg_chat_id,msg_id,Redis:get(XLaRiCaX.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(XLaRiCaX.."chadmin"..msg_chat_id) then
Redis:del(XLaRiCaX.."chadmin"..msg_chat_id) 
...
Redis:set(XLaRiCaX.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(XLaRiCaX.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(XLaRiCaX.."Lock:text"..msg_chat_id,true) 
...
Redis:set(XLaRiCaX.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(XLaRiCaX.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(XLaRiCaX.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(XLaRiCaX.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(XLaRiCaX.."lockalllll"..msg_chat_id,"off")
...
Redis:set(XLaRiCaX.."lockalllll"..msg_chat_id,"on")
...
Redis:set(XLaRiCaX.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(XLaRiCaX.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(XLaRiCaX.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(XLaRiCaX..''..lock..msg_chat_id,"del")    
end
...
Redis:del(XLaRiCaX.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(XLaRiCaX.."Lock:channell"..msg_chat_id)  
...
Redis:hset(XLaRiCaX.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(XLaRiCaX.."Lock:text"..msg_chat_id)  
...
Redis:del(XLaRiCaX.."Lock:Join"..msg_chat_id)  
...
Redis:del(XLaRiCaX.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(XLaRiCaX.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(XLaRiCaX.."lockpin"..msg_chat_id)  
...
Redis:del(XLaRiCaX.."Lock:edit"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(XLaRiCaX..''..lock..msg_chat_id)    
end
...
Redis:hset(XLaRiCaX.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(XLaRiCaX.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(XLaRiCaX.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(XLaRiCaX.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(XLaRiCaX.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(XLaRiCaX.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Link"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(XLaRiCaX..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(XLaRiCaX..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(XLaRiCaX..'lock:Fshar'..msg.chat_id) 
...
Redis:del(XLaRiCaX..'lock:Fars'..msg.chat_id) 
...
Redis:set(XLaRiCaX.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Photo"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Video"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Animation"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:geam"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Audio"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:vico"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:forward"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Document"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Contact"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Spam"..msg_chat_id)  
...
Redis:set(XLaRiCaX.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(XLaRiCaX.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(XLaRiCaX.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(XLaRiCaX.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(XLaRiCaX.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(XLaRiCaX.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(XLaRiCaX.."Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(XLaRiCaX.."Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(XLaRiCaX.."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(XLaRiCaX.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(XLaRiCaX.."Status:Welcome"..msg_chat_id) then
...
Redis:del(XLaRiCaX.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(XLaRiCaX.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(XLaRiCaX.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم ازالة قوانين الكروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(XLaRiCaX.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(XLaRiCaX.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(XLaRiCaX.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(XLaRiCaX.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(XLaRiCaX.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(XLaRiCaX.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(XLaRiCaX.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(XLaRiCaX..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ ارسل الان { ملصق ,متحركه ,صوره ,رساله }*',"md",true)  
end
...
Redis:set(XLaRiCaX.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(XLaRiCaX.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(XLaRiCaX.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(XLaRiCaX.."All:Get:Reides:Commands:Group"..v)
Redis:del(XLaRiCaX.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(XLaRiCaX.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(XLaRiCaX.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(XLaRiCaX.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(XLaRiCaX.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(XLaRiCaX.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(XLaRiCaX.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✓ ❭' else Statuslink = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✓ ❭' else StatusWelcome = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✓ ❭' else StatusId = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✓ ❭' else StatusIdPhoto = '❬ ✗ ❭'
end
if not Redis:get(XLaRiCaX.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if not Redis:get(XLaRiCaX.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✓ ❭' else StatusReplySudo = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✓ ❭' else StatusBanId = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✓ ❭' else StatusSetId = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✓ ❭' else StatusGames = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✓ ❭' else Statuskickme = '❬ ✗ ❭'
end
if Redis:get(XLaRiCaX.."Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(XLaRiCaX.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(XLaRiCaX.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(XLaRiCaX.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(XLaRiCaX.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(XLaRiCaX.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(XLaRiCaX.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(XLaRiCaX.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
if Redis:smembers(XLaRiCaX.."Supcreator:Group"..msg_chat_id) then
Redis:del(XLaRiCaX.."Supcreator:Group"..msg_chat_id) 
end
if Redis:smembers(XLaRiCaX.."Creator:Group"..msg_chat_id) then
Redis:del(XLaRiCaX.."Creator:Group"..msg_chat_id) 
end
if Redis:smembers(XLaRiCaX.."Manger:Group"..msg_chat_id) then
Redis:del(XLaRiCaX.."Manger:Group"..msg_chat_id) 
end
if Redis:smembers(XLaRiCaX.."Admin:Group"..msg_chat_id) then
Redis:del(XLaRiCaX.."Admin:Group"..msg_chat_id) 
end
if Redis:smembers(XLaRiCaX.."Special:Group"..msg_chat_id) then
Redis:del(XLaRiCaX.."Special:Group"..msg_chat_id) 
end
...
Redis:del(XLaRiCaX..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
Redis:del(XLaRiCaX..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(XLaRiCaX..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد رسائلك هنا*~ '..(Redis:get(XLaRiCaX..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد التعديلات هنا*~ '..(Redis:get(XLaRiCaX..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد جهاتك المضافه هنا*~ '..(Redis:get(XLaRiCaX.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(XLaRiCaX.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⋆ ارسل الان النص
⋆ يمكنك اضافه :
...
Redis:del(XLaRiCaX.."Set:Id:Groups")
...
Redis:setex(XLaRiCaX.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⋆ ارسل الان النص
⋆ يمكنك اضافه :
⋆ `#username` » اسم المستخدم
...
Redis:del(XLaRiCaX.."Set:Id:Group"..msg.chat_id)
...
Redis:del(XLaRiCaX.."Devss:Groups") 
...
Redis:del(XLaRiCaX.."klb:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."kholat:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."2rd:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."8by:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."3ra:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."smb:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."mar:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."twhd:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."wtka:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."ktmAll:Groups") 
...
Redis:del(XLaRiCaX.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(XLaRiCaX.."SilentGroup:Group"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/XLaRiCaXb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(XLaRiCaX.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(XLaRiCaX.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) 
Redis:del(XLaRiCaX.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(XLaRiCaX.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
Redis:del(XLaRiCaX.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
Redis:del(XLaRiCaX.."List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود \n━━━━━━━━━━━━\n"
for k,v in pairs(list) do
if Redis:get(XLaRiCaX.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه •"
elseif Redis:get(XLaRiCaX.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو •"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(XLaRiCaX.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},}}
...
if text then   
if Redis:get(XLaRiCaX..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
local test = Redis:get(XLaRiCaX..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
Redis:sadd(XLaRiCaX.."Add:Rd:array:Text"..test..msg_chat_id,text)  
_key = {
...
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(XLaRiCaX.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(XLaRiCaX.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(XLaRiCaX.."Add:Rd:array:Text"..gery..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:srem(XLaRiCaX.."Add:Rd:array:Text"..gery..msg_chat_id,text)
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  تم حذفه بنجاح .* ',"md",true)
end
end
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(XLaRiCaX.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(XLaRiCaX..'List:array'..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:set(XLaRiCaX.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(XLaRiCaX.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(XLaRiCaX.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end

if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(XLaRiCaX.."Set:array"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(XLaRiCaX.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(XLaRiCaX.."List:array"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(XLaRiCaX.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == "delrd" then
Redis:set(XLaRiCaX.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(XLaRiCaX.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(XLaRiCaX.."Add:Rd:array:Text"..text..msg_chat_id)
Redis:srem(XLaRiCaX..'List:array'..msg_chat_id, text)
...
Redis:set(XLaRiCaX.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
send_inlin_key(msg_chat_id,"⋆  ارسل الكلمه التي تريد حذفها",inlin,msg_id)
return false 
end
if text then
if  Redis:sismember(XLaRiCaX..'List:array'..msg_chat_id,text) then
local list = Redis:smembers(XLaRiCaX.."Add:Rd:array:Text"..text..msg_chat_id)
...
local list = Redis:smembers(XLaRiCaX..'List:array'..msg_chat_id..'')
...
local list = Redis:smembers(XLaRiCaX..'List:array'..msg_chat_id)
for k,v in pairs(list) do
Redis:del(XLaRiCaX.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(XLaRiCaX..'List:array'..msg_chat_id)
end
...
Redis:set(XLaRiCaX.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
text = "\n⋆ قائمة الردود العامه \n•━─━─━─━─━─━─━─━•\n"
for k,v in pairs(list) do
if Redis:get(XLaRiCaX.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:vico"..v) then
db = "بصمه ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:Text"..v) then
db = "رساله ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:Photo"..v) then
db = "صوره ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:Video"..v) then
db = "فيديو ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:File"..v) then
db = "ملف ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ⋆"
elseif Redis:get(XLaRiCaX.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو ⋆"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(XLaRiCaX..'GetTexting:DevXLaRiCaX'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(XLaRiCaX..'Texting:DevXLaRiCaX')
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevXLaRiCaX = Redis:get(XLaRiCaX..'Texting:DevXLaRiCaX')
if TextingDevXLaRiCaX then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevXLaRiCaX,"md",true)  
else
...
if Redis:get(XLaRiCaX.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if text and Redis:get(XLaRiCaX..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(XLaRiCaX..msg.chat_id.."name_mean"..msg.sender.user_id)
...
Redis:set(XLaRiCaX..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
Redis:setex(XLaRiCaX.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(XLaRiCaX.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(XLaRiCaX.."Name:Bot") or "لاريكا") then
local NamesBot = (Redis:get(XLaRiCaX.."Name:Bot") or "لاريكا")
local NameBots = {
"قلب "..NamesBot ,
"معاك",
"نعم ؟",
...
x = x + 1
Redis:srem(XLaRiCaX..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,XLaRiCaX)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⋆ البوت عضو في الكروب سوف اغادر ويمكنك تفعيلي مره اخره*',"md")
Redis:srem(XLaRiCaX..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(XLaRiCaX..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(XLaRiCaX..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(XLaRiCaX..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(XLaRiCaX.."Game:Smile"..msg.chat_id,SM)
...
Redis:set(XLaRiCaX.."mshaher"..msg.chat_id,name)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(XLaRiCaX.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(XLaRiCaX.."Game:Riddles"..msg.chat_id,name)
...
if Redis:get(XLaRiCaX.."Status:Games"..msg.chat_id) then
Redis:del(XLaRiCaX.."Set:Country"..msg.chat_id)
...
Redis:set(XLaRiCaX.."Game:Countrygof"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(XLaRiCaX.."Status:Games"..msg.chat_id) then
Redis:del(XLaRiCaX.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(XLaRiCaX.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(XLaRiCaX.."Status:Games"..msg.chat_id) then
Redis:del(XLaRiCaX.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(XLaRiCaX.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(XLaRiCaX.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(XLaRiCaX.."Game:Difference"..msg.chat_id,name)
...
Redis:set(XLaRiCaX.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(XLaRiCaX.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(XLaRiCaX.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:incrby(XLaRiCaX.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(XLaRiCaX.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:sadd(XLaRiCaX..'Num:User:Pv',msg.sender.user_id)  
if not msg.Devss then
if not Redis:get(XLaRiCaX.."Start:Bot") then
local CmdStart = '\n⋄︙مرحبا انا بوت '..(Redis:get(XLaRiCaX.."Name:Bot") or "لاريكا")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(XLaRiCaX.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(XLaRiCaX.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(XLaRiCaX.."TwaslBot") and not Redis:sismember(XLaRiCaX.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(XLaRiCaX.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(XLaRiCaX.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(XLaRiCaX..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⋆ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(XLaRiCaX..'BaN:In:Tuasl',Info_User)  
...
reply_markup = {
inline_keyboard ={
{{text ="• XLaRiCaX Source", url= "https://t.me/LaRiCaTeam"}},
}
},
},
}
...
Redis:srem(XLaRiCaX.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(XLaRiCaX..'*'..'-100'..data.supergroup.id..'*')
Redis:del(XLaRiCaX.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(XLaRiCaX.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(XLaRiCaX.."XLaRiCaX:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(XLaRiCaX.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(XLaRiCaX) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(XLaRiCaX..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == XLaRiCaX then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(XLaRiCaX..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(XLaRiCaX.."Lock:edit"..data.chat_id) then
...
data.The_Controller = 1
elseif Redis:sismember(XLaRiCaX.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(XLaRiCaX.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(XLaRiCaX.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(XLaRiCaX.."Supcreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(XLaRiCaX.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(XLaRiCaX.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(XLaRiCaX.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(XLaRiCaX.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(XLaRiCaX) then
...
if Redis:sismember(XLaRiCaX.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."Supcreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(XLaRiCaX.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(XLaRiCaX.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(XLaRiCaX.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(XLaRiCaX.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(XLaRiCaX.."Creator:Group"..ChatId,UserId[2])
Redis:srem(XLaRiCaX.."Special:Group"..ChatId,UserId[2])
Redis:srem(XLaRiCaX.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(XLaRiCaX.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(XLaRiCaX.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(XLaRiCaX.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(XLaRiCaX.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local Info_Members = Redis:smembers(XLaRiCaX.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Creator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Manger:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Admin:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(XLaRiCaX.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
*]]
Redis:set(XLaRiCaX.."youtube"..IdUser..ChatId,'mp3')
...
Redis:set(XLaRiCaX.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local UserId = {Text:match('(%d+)/statusTheBasicsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(XLaRiCaX.."XLaRiCaX:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."XLaRiCaX:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."XLaRiCaX:TheBasics:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusOriginatorsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(XLaRiCaX.."XLaRiCaX:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."XLaRiCaX:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."XLaRiCaX:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusManagersz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(XLaRiCaX.."XLaRiCaX:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."XLaRiCaX:Managers:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."XLaRiCaX:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusAddictivez/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(XLaRiCaX.."XLaRiCaX:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."XLaRiCaX:Addictive:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."XLaRiCaX:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusDistinguishedz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(XLaRiCaX.."XLaRiCaX:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."XLaRiCaX:Distinguished:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."XLaRiCaX:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(XLaRiCaX.."XLaRiCaX:Originators:Group"..ChatId,UserId[2])
Redis:srem(XLaRiCaX.."XLaRiCaX:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(XLaRiCaX.."XLaRiCaX:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(XLaRiCaX.."XLaRiCaX:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Redis:sismember(XLaRiCaX.."XLaRiCaX:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."XLaRiCaX:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(XLaRiCaX.."XLaRiCaX:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'banned',0)
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
...
if Redis:sismember(XLaRiCaX.."XLaRiCaX:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(XLaRiCaX.."XLaRiCaX:SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(XLaRiCaX.."XLaRiCaX:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:incrby(XLaRiCaX.."Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(XLaRiCaX.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/LaRiCaTeam'}, },}}
Redis:del(XLaRiCaX.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(XLaRiCaX.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(XLaRiCaX.."Set:array"..IdUser..":"..ChatId)
Redis:del(XLaRiCaX.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(XLaRiCaX.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(XLaRiCaX.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(XLaRiCaX.."Set:On"..IdUser..":"..ChatId)
...
if Redis:get(XLaRiCaX..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(XLaRiCaX..'Set:array'..IdUser..':'..ChatId)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ XLaRiCaX',url='http://t.me/LaRiCaTeam'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ XLaRiCaX',url='http://t.me/LaRiCaTeam'}},}
...
Redis:set(XLaRiCaX.."toar"..IdUser,"on")
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
Redis:set(XLaRiCaX.."toen"..IdUser,"on")
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(XLaRiCaX.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(XLaRiCaX.."ChekBotAdd",UserId[2])
Redis:set(XLaRiCaX.."Status:Id"..UserId[2],true) ;Redis:del(XLaRiCaX.."Status:Reply"..UserId[2]) ;Redis:del(XLaRiCaX.."Status:ReplySudo"..UserId[2]) ;Redis:set(XLaRiCaX.."Status:BanId"..UserId[2],true) ;Redis:set(XLaRiCaX.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(XLaRiCaX.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(XLaRiCaX.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'تعط','تعطيل الايدي بالصوره')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"تعط")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'تفع','تفعيل الايدي بالصوره')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"تفع")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'ا','ايدي')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"ا")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'م','رفع مميز')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"م")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'اد', 'رفع ادمن')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"اد")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'مد','رفع مدير')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"مد")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'من', 'رفع منشئ')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"من")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'اس', 'رفع منشئ اساسي')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"اس")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'مط','رفع مطور')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"مط")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'ثانوي','رفع مطور ثانوي')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"ثانوي")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'تك','تنزيل الكل')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"تك")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'ر','الرابط')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"ر")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'رر','ردود المدير')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"رر")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'مسح المكتومين','ممكتومين')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"ممكتومين")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'رد','اضف رد')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"رد")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'سح','مسح سحكاتي')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"سح")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'رس','مسح رسائلي')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"رس")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'غ','غنيلي')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"غ")
Redis:set(XLaRiCaX.."Get:Reides:Commands:Group"..ChatId..":"..'#','مسح قائمه العام')
Redis:sadd(XLaRiCaX.."Command:List:Group"..ChatId,"#")
local txxt = [[
⋆ تم ترتيب الاوامر بالشكل التالي ~
⋆  ايدي - ا .
⋆  رفع مميز - م .
...
XLaRiCaXusername = '*تم الزواج بنجاح \nمبروك  يا  ↫ *['..bain.first_name..'](tg://user?id='..bain.id..' *\n*'
else
XLaRiCaXusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,XLaRiCaXusername, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(XLaRiCaX.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(XLaRiCaX.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(XLaRiCaX.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(XLaRiCaX.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(XLaRiCaX.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(XLaRiCaX..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(XLaRiCaX.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Owners:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Creator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Manger:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Admin:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⋆ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(XLaRiCaX.."SilentGroup:Group"..ChatId) 
